...
export interface Package {
  ...
  region: string;
  tiers: string;
  /** HK$ from-price of the flight + bike version without hotel (leaflet p4): P3 bike, 3日2夜. */
  priceFrom: number;
  /** HK$ from-price of the flight + hotel with breakfast + bike version (leaflet p3), P3 bike. */
  hotelFrom: number;
  /** The duration the with-hotel `hotelFrom` price is quoted for. */
  hotelDuration: string;
  /** Airline the leaflet's base fare is quoted on. */
  airline: string;
  /**
  ...
  "zh-hk": [
    {
      ...
      title: "大阪・昇龍道 二輪自駕套票",
      region: "大阪／中部",
      tiers: "3日2夜 / 4日3夜 / 5日4夜",
      priceFrom: 5680,
      hotelFrom: 10880,
      hotelDuration: "5日4夜",
      airline: "香港快運 (UO)",
      blurb: "由大阪出發走昇龍道，機票連電單車一次過搞掂，亦可選連住宿版本，自由編排行程。",
    ...
    },
    {
      ...
      hotelDuration: "5日4夜",
      airline: "香港快運 (UO)",
      blurb: "阿蘇火山與牛奶之路的經典九州路線，機票＋電單車套票最抵玩。",
    ...
    },
    {
      ...
      hotelDuration: "5日4夜",
      airline: "大灣區航空 (HB)",
      blurb: "朝聖《頭文字D》經典山路，暢遊關東名所的機票＋電單車組合。",
  ...
  en: [
    {
      ...
      region: "Osaka / Chubu",
      tiers: "3D2N / 4D3N / 5D4N",
      priceFrom: 5680,
      hotelFrom: 10880,
      hotelDuration: "5 days / 4 nights",
      airline: "HK Express (UO)",
      blurb: "Ride the Shoryudo route from Osaka — flight and bike bundled, with an optional hotel version; the itinerary is your call.",
    ...
    },
    {
      ...
      hotelDuration: "5 days / 4 nights",
      airline: "HK Express (UO)",
      blurb: "The classic Kyushu loop past Aso's volcano and Milk Road — the best-value flight + bike bundle.",
    ...
    },
    {
      ...
      blurb: "Chase the Initial D mountain passes and Kanto highlights with a flight + bike combo.",
