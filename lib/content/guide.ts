  ...
  "zh-hk": [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "詳細的車款租金及費用以租車表格報價為準。由於價格會隨車輛等級、租用日期及分店而變動，最準確的方法是透過預約表格或 WhatsApp 向我們索取報價。",
        },
        {
          type: "note",
          text: "如需報價，請使用網站的租車預約表格，或 WhatsApp 我們的團隊：wa.me/85298686569。",
        },
        { type: "h3", text: "費用組成" },
        {
          type: "ul",
  ...
  en: [
    ...
    },
    {
      ...
      blocks: [
        {
          type: "p",
          text: "Detailed rental rates and fees are confirmed by the quote on the rental form. Because prices vary by vehicle class, rental dates and branch, the most accurate way is to request a quote through the booking form or via WhatsApp.",
        },
        {
          type: "note",
          text: "For a quote, please use the rental booking form on the website, or WhatsApp our team: wa.me/85298686569.",
        },
